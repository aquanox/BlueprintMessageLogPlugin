...
namespace UK2Node_AddBlueprintMessageTextTokenHelper
{
	static const FName PN_MessagePinName(TEXT("Message"));
	static const FName PN_SlotPinName(TEXT("Slot"));
	static const FName PN_FormatPinName(TEXT("Format"));
}
...
void UK2Node_AddBlueprintMessageTextToken::AllocateDefaultPins()
{
	...
	auto CachedMessagePin = CreatePin(EGPD_Output, UEdGraphSchema_K2::PC_Object, UBlueprintMessage::StaticClass(), UK2Node_AddBlueprintMessageTextTokenHelper::PN_MessagePinName);

	auto CachedSlotPin = CreatePin(EGPD_Input, UEdGraphSchema_K2::PC_Name, UK2Node_AddBlueprintMessageTextTokenHelper::PN_SlotPinName);
	...
	CachedInputPins.Add(UK2Node_AddBlueprintMessageTextTokenHelper::PN_SlotPinName, CachedSlotPin);

	auto CachedFormatPin = CreatePin(EGPD_Input, UEdGraphSchema_K2::PC_Text, UK2Node_AddBlueprintMessageTextTokenHelper::PN_FormatPinName);
	...
	CachedInputPins.Add(UK2Node_AddBlueprintMessageTextTokenHelper::PN_FormatPinName, CachedFormatPin);
...
void UK2Node_AddBlueprintMessageTextToken::ExpandNode(class FKismetCompilerContext& CompilerContext, UEdGraph* SourceGraph)
{
	...
	*/
	...
	CompilerContext.MovePinLinksToIntermediate(*FindPinChecked(UK2Node_AddBlueprintMessageTextTokenHelper::PN_MessagePinName, EGPD_Output), *CallAddTokenNode->GetReturnValuePin());
...
UEdGraphPin* UK2Node_AddBlueprintMessageTextToken::GetSlotPin() const
{
	return FindInputPin(UK2Node_AddBlueprintMessageTextTokenHelper::PN_SlotPinName);
}

UEdGraphPin* UK2Node_AddBlueprintMessageTextToken::GetFormatPin() const
{
	return FindInputPin(UK2Node_AddBlueprintMessageTextTokenHelper::PN_FormatPinName);
}
